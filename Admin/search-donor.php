            ...
            <table class="table table-bordered">
                ...
                <?php foreach ($results as $result) { ?>
                    <tr>
                        ...
                        <td><a class="btn" href="request.php?cid=<?= $result->id ?>">Request</a></td>
                    </tr>
                <?php } ?>
            </table>
        <?php } else { ?>
